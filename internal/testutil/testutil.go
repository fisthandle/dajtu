// Package testutil provides test helpers for dajtu.
package testutil
...
// TestConfig returns a config for testing with temp data directory
...
// SampleJPEG returns minimal valid JPEG bytes (1x1 pixel red JPEG)
...
// SamplePNG returns minimal valid PNG bytes (1x1 pixel red PNG)
func SamplePNG() []byte {
	return []byte{
...
// SampleGIF returns minimal valid GIF bytes (1x1 pixel GIF)
func SampleGIF() []byte {
	return []byte{
...
// SampleWebP returns minimal valid WebP bytes (1x1 pixel WebP)
